    ...
    <header className="hero is-info is-bold">
      <div className="hero-body ">
        <div className="container">
          ...
          <h2 className="is-6 has-text-centered">5420025 山城昂平</h2>
          <h2 className=" is-6 has-text-centered">日本大学文理学部情報科学科</h2> 
          <h2 className="is-6 has-text-centered">Webプログラミングの演習課題</h2>
        </div>
      </div>
    </header>
  );
